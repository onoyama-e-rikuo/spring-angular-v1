...
import net.matondo.domain.HttpResponse;
...
import net.matondo.utility.JWTTokenProvider;
...
import static net.matondo.constant.SecurityConstant.JWT_TOKEN_HEADER;
...
public class UserResource extends ExceptionHandling {
    ...
    public ResponseEntity<HttpResponse> deleteUser(@PathVariable("id") long id) throws IOException, UserNotFoundException, UsernameExistException, EmailExistException {
